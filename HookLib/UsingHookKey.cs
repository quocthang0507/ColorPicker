...
namespace HookLib
{
    ...
    public class UsingHookKey
    {
        ...
        {
            FieldInfo[] props = typeof(HookLib.VKCodeConst).GetFields(BindingFlags.Public | BindingFlags.Static);
            FieldInfo wantedprop = props.FirstOrDefault(prop => (int)prop.GetValue(null) == value);
